export default class CollapseItem extends HTMLElement {
  constructor() {
    ...
    const collapseItemTmpl = document.getElementById("collapse_item_template");
    const cloneTemplate = collapseItemTmpl.content.cloneNode(true);
    ...
    this.titleEle.addEventListener("click", () => {
      // 如果将结果传递给父亲  组件通信？
      document.querySelector("zgy-collapse").dispatchEvent(
